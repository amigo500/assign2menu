...
namespace StringManipulation
{
    class Program
    {
        ...
        private static void LotsOfCost()
        {
            int i, j, n;
            int[] a = new int[100];
            int sum = 0;
            ...
            Console.Write("\n\nThe number of people in your company and the total cost of your movie tickets: \n");
            Console.Write("------------------------------------------------------------------------------\n");

            Console.Write("Input the number of guys who wants to buy a movie ticket: ");
            n = Convert.ToInt32(Console.ReadLine());


            for (i = 0; i < n; i++)
            {
                Console.Write("Age of person {0}: ", j);
                ...
                if (j > n)
                {
                    Console.Write("\nThe total cost of your tickets to the cinema: ", sum);
                    Console.Write("{0}  ", sum);
                    Thread.Sleep(4000);
                    Console.Write("\r\nPress Enter to return to Main Menu");
                    Console.ReadLine();
